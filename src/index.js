  ...
  async function fetchPopularMovies() {
    try {
      ...
      data.results.slice(0, moviesPerPage).forEach(async (movie) => {
        ...
        const contenidoDescriptionMovies = document.getElementsByClassName("contenido-description-movies")
        contenidoDescriptionMovies.innerHTML = ` 
        Vote / Votes: ${movie.vote_average}<br>
